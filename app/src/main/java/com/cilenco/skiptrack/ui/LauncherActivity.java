...
public class LauncherActivity extends Activity {
    ...
    public void onResume() {
        ...
        Log.d("cilenco", "onCreate -> permission = " + permission);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        Log.d("cilenco", "onRequestPermissionsResult -> " + permissions[0] + ", " + grantResults[0]);
        if (grantResults[0] == PackageManager.PERMISSION_GRANTED) startServiceAndFinish();
    }
